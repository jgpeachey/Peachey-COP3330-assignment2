...
/*
Create a program that generates a multiplication table for the numbers 1
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        outputCreator(calc.multiplicationTable());
    }

    public static void outputCreator(int[] num) {
        for (int i = 1; i < 145; i++) {
            System.out.format("%10d", num[i-1]);
            if(i%12 == 0){
                System.out.println("");
            }
        }
